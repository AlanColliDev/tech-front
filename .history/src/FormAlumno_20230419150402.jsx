...
export const FormAlumno = () => {
	...
	const { HandleSendForm } = useAlumno();
	...
	return (
		<>
			<div className="shadow-md m-5 py-4 px-6">
				...
				<form className="w-full" onSubmit={HandleSendForm}>
					...
					<button type="buttonp" className="bg-blue-600 text-sm text-white font-medium text-opacity-100 px-4 py-2 rounded-3xl">Guardar</button>
				</form>
			</div>
		</>
	)
